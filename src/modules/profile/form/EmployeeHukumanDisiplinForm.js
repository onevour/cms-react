...
class EmployeeHukumanDisiplinForm extends Component {
    ...
    submitForm(e) {
        ...
        this.props.updateDisiplin(param)
        this.setState({request: 1})
    }

    handleRemove(o, index) {
        swal({
            title: "Hapus Hukuman Disiplin",
            text: "hapus Hukuman Disiplin tahun " + formatYear(o.tahun) + ", " + o.hukuman + "?",
            icon: "info",
            buttons: true,
            dangerMode: false,
        }).then((willDelete) => {
            if (willDelete) {
                this.props.removeDisiplin(o)
            }
        });
    }
                ...
                <div className="col-md-3">
                    <form className="forms-sample" ref={(ref) => this.formRef = ref}
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control" placeholder="Hukuman disiplin"
