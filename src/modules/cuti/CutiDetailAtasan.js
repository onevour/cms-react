...
import {approveAtasanCuti, loadCutiUserLogin} from "../../redux/actions/reduxAction";
    ...
    cancelExistCuti(e) {
        ...
        swal({
            ...
            if (willDelete) {
                ...
                this.props.approveAtasanCuti(payload)
            }
        });
    }
...
export default connect(mapStateToProps, {approveAtasanCuti})(CutiDetailAtasan);
